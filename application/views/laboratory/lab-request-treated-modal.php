                                ...
                                <tbody>
                                   ...
                                   // foreach ($tests as $test) { 
                                        ...
                                        if ($tests->has_subgroup=='No') {
                                            ...
                                            if (count($ranges)==0) {
                                                ...
                                                <tr class="request">
                                                    ...
                                                    <input type="text" hidden value="<?php echo $tests->id; ?>" name="lab_test_id[]"><?php echo $this->laboratory_m->get_lab_results($tests->id,$this->uri->segment(3))->result; ?>
                                                    </td>
                                                    <td>
                                        ...
                                        <tr class="request">
                                                    ...
                                                    <input type="text" hidden value="<?php echo $lab_group->id; ?>" name="lab_test_subgroup_id[]"><?php echo $this->laboratory_m->get_lab_results2($lab_group->id,$this->uri->segment(3))->result; ?>
                                                    </td>
                                                    <td>
