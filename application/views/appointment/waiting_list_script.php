...
function listDefaultPatientsWL() {
      ...
      success : function(response){
        ...
        for(i=0; i<response.length; i++){
            ...
            // }
            var buttons = '<button class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5 button-edit" onclick="shiNew(event)" data-type="purple" data-size="xl" data-title="Take Vital for " href="<?php echo base_url('patient/view/'); ?>' + response[i].app_id + '"><i class="icon-eye" aria-hidden="true"></i></button>';
