        ...
        <div class="card-body" style="padding: 1px;">
                <div class="modal-body edit-doc-profile">
                    <div class="row clearfix">
                        ...
                        $receipt_id = $this->billing_m->generate_receipt_id();
                        ?>
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control time24" hidden="" value="<?php echo $patient_details->patient_id_num; ?>" name="hospital_number">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Receipt Number</b>
                            <div class="input-group">
                                <input type="text" class="form-control time24" disabled="" value="<?php echo $receipt_id; ?>">
                                <input type="text" class="form-control time24" name="receipt_id" value="<?php echo $receipt_id; ?>">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Name</b>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control time12" value="<?php echo $patient_details->patient_name; ?>" hidden="" name="patient_name">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Amount Due</b>
                ...
                <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Full Payment</b>
                            <div class="input-group"><input type="" name="items_group_id" value="<?php echo $this->uri->segment(3); ?>"><input type="text" hidden="" id="total_payment" value="<?php echo $this->billing_m->invoice_total2($this->uri->segment(3)); ?>"  name="displayed_total">
