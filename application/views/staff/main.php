                           ...
                           <!--          <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            ...
                                            data-toggle="tooltip" data-original-title="Edit" onclick="get_staff_data('<?php echo $staff->s_id; ?>')"><i class="icon-pencil" aria-hidden="true" data-toggle="modal" data-target="#addstaff"></i></a>
                                            <button class="btn btn-sm btn-icon btn-pure btn-default on-default button-remove"
                                            data-toggle="tooltip" data-original-title="Remove" onclick="delete_role_name('<?php echo $staff->s_id; ?>')"><i class="icon-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; } ?> -->
                                </tbody>
