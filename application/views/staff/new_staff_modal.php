                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <select class="form-control" name="title">
                                ...
                                <option <?php if ($this->uri->segment(3)) { if($salutation->id == $staff_details->staff_title) {  ?> selected <?php } } ?> value="<?php echo $salutation->id; ?>"><?php echo $salutation->title; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            <select class="form-control" name="state">
                                ...
                                <?php foreach ($states_list as $state) { ?>
                                    <option <?php if ($this->uri->segment(3)) { if($state->id == $staff_details->staff_state) {  ?> selected <?php } } ?>  value="<?php echo $state->id ?>"><?php echo $state->name; ?></option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <select class="form-control" name="gender">
                                ...
                                <option <?php if ($this->uri->segment(3)) { if($staff_details->staff_gender=='male') {  ?> selected <?php } } ?> value="male">Male</option>
                                <option <?php if ($this->uri->segment(3)) { if($staff_details->staff_gender=='female') {  ?> selected <?php } } ?> value="female">Female</option>
                            </select>
                            <code style="color: #ff0000;font-size: 9px;" class="form-control-feedback" data-field="gender"></code>
                        </div>
                        <label class="fancy-checkbox">
                            ...
                            <input id="can_consult2" type="checkbox" <?php if ($this->uri->segment(3)) { if($staff_details->can_consult=='1') {  ?> checked <?php } } ?> name="can_consult" value="1">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <select class="form-control" name="department">
                                ...
                                <option <?php if ($this->uri->segment(3)) { if($department->id == $staff_details->department_id) {  ?> selected <?php } } ?> value="<?php echo $department->id; ?>"><?php echo $department->department_name ?></option>
                                <?php } ?>
                            </select>
