                ...
                <div class="modal-body edit-doc-profile">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Weight(kg)</b>
                            <div class="input-group">
                                <input type="number" class="form-control numbersOnly" onkeypress="weight_not_empty()" name="weight" id="weight2" placeholder="75" <?php if ($this->uri->segment(3) && isset($vital_details->weight)) { ?>value="<?php echo $vital_details->weight; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Height(m)</b>
                            <div class="input-group">
                                <input type="number" class="form-control numbersOnly" onkeydown="not_empty()" onblur="calc_bmi()" name="height" id="height2" placeholder="1.75" <?php if ($this->uri->segment(3) && isset($vital_details->height)) { ?>value="<?php echo $vital_details->height; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <b>BMI</b>
                            <div class="input-group">
                                <input type="number" class="form-control money-dollar" readonly="" name="BMI" id="bmi2" placeholder="22.9" <?php if ($this->uri->segment(3) && isset($vital_details->BMI)) { ?>value="<?php echo $vital_details->BMI; ?>" <?php } ?>>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <b>BMI Remark</b>
                            <div class="input-group">
                                <input type="text" class="form-control ip" readonly="" name="bmi_remark" id="bmi_remark2" placeholder="Obese" <?php if ($this->uri->segment(3) && isset($vital_details->bmi_remark)) { ?>value="<?php echo $vital_details->bmi_remark; ?>" <?php } ?>>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>HC</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="46" name="HC" id="HC" <?php if ($this->uri->segment(3) && isset($vital_details->HC)) { ?>value="<?php echo $vital_details->HC; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>MUAC (Paed.)</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="75" name="MUAC" id="MUAC" <?php if ($this->uri->segment(3) && isset($vital_details->MUAC)) { ?>value="<?php echo $vital_details->MUAC; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="60" name="nutritional_status" id="nutritional_status" <?php if ($this->uri->segment(3) && isset($vital_details->nutritional_status)) { ?>value="<?php echo $vital_details->nutritional_status; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>Temp</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="75" name="temp" id="temp" <?php if ($this->uri->segment(3) && isset($vital_details->temp)) { ?>value="<?php echo $vital_details->temp; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>Urine(ANC)</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="60" name="ANC" id="ANC" <?php if ($this->uri->segment(3) && isset($vital_details->ANC)) { ?>value="<?php echo $vital_details->ANC; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>Respiration</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="45" name="respiration" id="respiration" <?php if ($this->uri->segment(3) && isset($vital_details->respiration)) { ?>value="<?php echo $vital_details->respiration; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>Pulse</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="75" name="paulse" id="paulse" <?php if ($this->uri->segment(3) && isset($vital_details->paulse)) { ?>value="<?php echo $vital_details->paulse; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>SPO2</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="60" name="SPO2" id="SPO2" <?php if ($this->uri->segment(3) && isset($vital_details->SPO2)) { ?>value="<?php echo $vital_details->SPO2; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            ...
                            <b>RE</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="75" name="RE" id="RE" <?php if ($this->uri->segment(3) && isset($vital_details->RE)) { ?>value="<?php echo $vital_details->RE; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 mb-3"><br>
                            <b>LE</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" placeholder="60" name="LE" id="LE" <?php if ($this->uri->segment(3) && isset($vital_details->LE)) { ?>value="<?php echo $vital_details->LE; ?>" <?php } ?>>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>EDD</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" readonly id="edd" name="EDD" placeholder="75" <?php if ($this->uri->segment(3) && isset($vital_details->EDD)) { ?>value="<?php echo $vital_details->EDD; ?>" <?php } ?>>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>EGA</b>
