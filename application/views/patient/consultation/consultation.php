                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="" class="form-control date" disabled="" value="<?php if ($this->uri->segment(3) && isset($consultation_details->con_id)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Complaint</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="complaint" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->complaint)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <textarea rows="" cols="" name="presenting_complaint" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->presenting_complaint)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Past Medical HX</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="past_medical_hx" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->past_medical_hx)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Immunization HX</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="immunization_hx" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->immunization_hx)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Family HX</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="family_hx" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->family_hx)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <textarea rows="" cols="" name="diet" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->diet)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Examination</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="examination" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->examination)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Results</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="result" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->result)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <textarea rows="" cols="" name="assignment" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->assignment)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Investigation</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="investigation" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->investigation)) {
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <b>Summary</b>
                            <div class="input-group">
                                <textarea rows="" cols="" name="summary" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->summary)) {
