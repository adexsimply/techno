                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="" class="form-control" disabled="" value="<?php if ($this->uri->segment(3) && isset($consultation_details->con_id)) {
                                                                                                echo date('jS \of F Y', strtotime($consultation_details->date));
                                                                                            } else {
                                                                                                echo date('d M Y');
                                                                                            } ?>">
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Hospital Number</b>
                            <div class="input-group">
                                <input type="text" class="form-control time24" disabled="" value="<?php if ($this->uri->segment(3) && isset($consultation_details->con_id)) {
                                                                                                        echo $consultation_details->patient_id_num;
                                                                                                    } else {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Age</b>
                            <div class="input-group">
                                <input type="text" class="form-control datetime" disabled="" value="<?php if ($this->uri->segment(3) && isset($consultation_details->con_id)) {
                                                                                                        echo date_diff(date_create($consultation_details->patient_dob), date_create('today'))->y;
                                                                                                    } else {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Account Status</b>
                            <div class="input-group">
                                <input type="text" class="form-control datetime" disabled="" value="<?php if ($this->uri->segment(3) && isset($consultation_details->patient_status)) {
                                                                                                        echo $consultation_details->patient_status;
                                                                                                    } else {
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>Name</b>
                            <div class="input-group">
                                <input type="text" class="form-control time12" value="<?php if ($this->uri->segment(3) && isset($consultation_details->patient_name)) {
                                                                                            echo $consultation_details->patient_name;
                                                                                        } else {
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>Sex</b>
                            <div class="input-group">
                                <input type="text" class="form-control time12" value="<?php if ($this->uri->segment(3) && isset($consultation_details->patient_gender)) {
                                                                                            echo $consultation_details->patient_gender;
                                                                                        } else {
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <b>Clinic</b>
                            <div class="input-group">
                                <input type="text" class="form-control time12" value="<?php if ($this->uri->segment(3) && isset($consultation_details->clinic_name)) {
                                                                                            echo $consultation_details->clinic_name;
                                                                                        } else {
                        ...
                        <div class="col-lg-2 col-md-6 mb-3">
                            <b>Weight(kg)</b>
                            <div class="input-group">
                                <input type="number" class="form-control numbersOnly" readonly placeholder="75" value="<?php if ($this->uri->segment(3) && isset($consultation_details->weight)) {
                                                                                                                            echo $consultation_details->weight;
                                                                                                                        } else {
                        ...
                        <div class="col-lg-2 col-md-6 mb-3">
                            <b>Height(m)</b>
                            <div class="input-group">
                                <input type="number" class="form-control numbersOnly" readonly name="height" id="height2" placeholder="1.75" value="<?php if ($this->uri->segment(3) && isset($consultation_details->height)) {
                                                                                                                                                        echo $consultation_details->height;
                                                                                                                                                    } else {
                        ...
                        <div class="col-lg-2 col-md-6 mb-3">
                            <b>Temp</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" readonly value="<?php if ($this->uri->segment(3) && isset($consultation_details->temp)) {
                                                                                                        echo $consultation_details->temp;
                                                                                                    } else {
                        ...
                        <div class="col-lg-2 col-md-6 mb-3">
                            <b>BP</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" readonly value="<?php if ($this->uri->segment(3) && isset($consultation_details->BP)) {
                                                                                                        echo $consultation_details->BP;
                                                                                                    } else {
                        ...
                        <div class="col-lg-1 col-md-6 mb-3">
                            <b>Pulse</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" readonly value="<?php if ($this->uri->segment(3) && isset($consultation_details->paulse)) {
                                                                                                        echo $consultation_details->paulse;
                                                                                                    } else {
                        ...
                        <div class="col-lg-1 col-md-6 mb-3">
                            <b>HC</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" readonly value="<?php if ($this->uri->segment(3) && isset($consultation_details->HC)) {
                        ...
                        <div class="col-lg-2 col-md-6 mb-3">
                            <b>Respiration</b>
                            <div class="input-group">
                                <input type="text" class="form-control numbersOnly" readonly value="<?php if ($this->uri->segment(3) && isset($consultation_details->respiration)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Complaint</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="complaint" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->complaint)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <textarea rows="7" cols="" name="presenting_complaint" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->presenting_complaint)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Past Medical HX</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="past_medical_hx" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->past_medical_hx)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Immunization HX</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="immunization_hx" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->immunization_hx)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Family HX</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="family_hx" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->family_hx)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <textarea rows="7" cols="" name="diet" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->diet)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Examination</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="examination" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->examination)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Results</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="result" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->result)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <textarea rows="7" cols="" name="assignment" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->assignment)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Investigation</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="investigation" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->investigation)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Treatment</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="treatment" id="treatment" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->treatment)) {
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <b>Summary</b>
                            <div class="input-group">
                                <textarea rows="7" cols="" name="summary" class="form-control"><?php if ($this->uri->segment(3) && isset($consultation_details->summary)) {
