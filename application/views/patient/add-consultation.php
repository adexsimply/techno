    ...
    <div class="col-lg-12" id="footer-links">
        <div class="card">
            <div class="body">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Home-withicon2"><i class="fa fa-home"></i> Prescription</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Profile-withicon2"><i class="fa fa-user"></i> Lab Investigation</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Contact-withicon2"><i class="fa fa-vcard"></i> Radiological Investigation</a></li>
                </ul>
            </div>
        </div>
    </div>
